...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__movie_movie_component__["a" /* MovieComponent */]
        ],
        imports: [
...
var MovieService = (function () {
    ...
    MovieService.prototype.getMovieByTitle = function (title) {
        ...
        return this.http.get("http://" + window.location.hostname + ":8070/getMovieByTitle?title=" + title, {
            headers: headers
        });
    };
    return MovieService;
...
module.exports = "<div>\n    <input type=\"text\" #title placeholder=\"movie name\"/>\n    <button type=\"button\" class=\"btn btn-info btn-sm\" (click)=\"getMovieByTitle(title.value)\">\n      <span class=\"glyphicon glyphicon-search\"></span> Search \n    </button>\n<div *ngIf=\"movie\">\n  <ul>\n    <li>Title: {{movie.Title}}\n    </li>\n    <li>Genre: {{movie.Genre}}\n      </li>\n    <li>IMDB rating: {{movie.imdbRating}}\n      </li>\n    <li>Director: {{movie.Director}}\n      </li>\n    <li><p class=\"well well-sm\">Plot: {{movie.Plot}}</p>\n      </li>\n      <img [src]=\"movie.Poster\"/>\n  </ul>\n</div>\n</div>"
...
var MovieComponent = (function () {
    ...
    MovieComponent.prototype.getMovieByTitle = function (title) {
        var _this = this;
        this.movieService.getMovieByTitle(title).subscribe(function (data) {
            _this.movie = data;
        });
    };
